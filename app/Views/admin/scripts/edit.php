  ...
  <form method="POST" id="editForm" action="/admin/scripts/<?= esc($script['id']) ?>/edit">
    <div class="form-grid">
      ...
      <div class="form-group" style="grid-column: 1 / -1; margin-top: 10px;">
        <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:8px;">
          <div style="display:flex; align-items:center; gap:12px;">
            ...
            <label class="toggle-switch" style="width: 44px; height: 24px; position:relative; display:inline-block;">
              <input type="checkbox" id="enable_linux" name="enable_linux" value="1" <?= old('enable_linux', $script['enable_linux'] ?? 0) ? 'checked' : '' ?> onchange="toggleLinuxInput()" style="opacity:0; width:0; height:0;">
        ...
        <div id="linux_input_container" style="display: <?= old('enable_linux', $script['enable_linux'] ?? 0) ? 'block' : 'none' ?>; margin-top: 10px; padding: 15px; border-radius: 12px; background: rgba(16,185,129,0.05); border: 1px solid rgba(16,185,129,0.15);">
          <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:8px;">
          ...
          <input id="command_linux" name="command_linux" type="text" class="form-control"
            value="<?= esc(old('command_linux', $script['command_linux'] ?? '')) ?>"
